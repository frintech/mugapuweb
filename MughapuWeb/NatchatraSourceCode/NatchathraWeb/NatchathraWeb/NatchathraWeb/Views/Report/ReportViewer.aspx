...
if (!IsPostBack)
{
List<NatchathraWeb.Models.UserTransaction> objuserTranList =null;
using (NatchathraWeb.DAL.NatchathraEntities db = new NatchathraWeb.DAL.NatchathraEntities())
 {
...
objuserTranList = new List<NatchathraWeb.Models.UserTransaction>();
...
{
    NatchathraWeb.Models.UserTransaction obj = new NatchathraWeb.Models.UserTransaction();
    obj.Userid = d.UserId;
    obj.Name = d.Name;
    obj.EmailId = d.email;
