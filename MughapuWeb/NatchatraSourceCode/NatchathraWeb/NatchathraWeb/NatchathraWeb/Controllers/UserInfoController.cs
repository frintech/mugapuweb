    ...
    public class UserInfoController : Controller
    {
       ...
       [Authorize]
        ...
        public ActionResult ChangePassword()
        {
            ...
            //    message == NatchathraWeb.Controllers.AccountController.ManageMessageId.ChangePasswordSuccess ? "Your password has been changed."
            //    : message == NatchathraWeb.Controllers.AccountController.ManageMessageId.SetPasswordSuccess ? "Your password has been set."
            //    : message == NatchathraWeb.Controllers.AccountController.ManageMessageId.RemoveLoginSuccess ? "The external login was removed."
            //    : "";
        ...
        public ActionResult ChangePassword(UserPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        return RedirectToAction("Manage", new { Message = NatchathraWeb.Controllers.AccountController.ManageMessageId.ChangePasswordSuccess });
                    }
                    else
                    {
