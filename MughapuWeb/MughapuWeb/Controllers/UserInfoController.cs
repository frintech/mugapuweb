    ...
    public class UserInfoController : Controller
    {
       ...
       [AllowAnonymous]
        ...
        public ActionResult ChangePassword()
        {
            ...
            //    message == MughapuWeb.Controllers.AccountController.ManageMessageId.ChangePasswordSuccess ? "Your password has been changed."
            //    : message == MughapuWeb.Controllers.AccountController.ManageMessageId.SetPasswordSuccess ? "Your password has been set."
            //    : message == MughapuWeb.Controllers.AccountController.ManageMessageId.RemoveLoginSuccess ? "The external login was removed."
            //    : "";
