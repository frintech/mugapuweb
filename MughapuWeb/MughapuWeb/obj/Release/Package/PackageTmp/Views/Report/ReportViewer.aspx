...
if (!IsPostBack)
{
List<MughapuWeb.Models.UserTransaction> objuserTranList =null;
using (MughapuWeb.DAL.MughapuEntities db = new MughapuWeb.DAL.MughapuEntities())
 {
...
objuserTranList = new List<MughapuWeb.Models.UserTransaction>();
...
{
    MughapuWeb.Models.UserTransaction obj = new MughapuWeb.Models.UserTransaction();
    obj.Userid = d.UserId;
    obj.Name = d.Name;
    obj.EmailId = d.email;
